...
execute if predicate geegaz:ggpi/item/prop_eraser/in_hand at @e[type=armor_stand,tag=ggpi.prop,tag=!ggpi.undo,distance=..5] run particle dust 1.000 0.000 0.000 1.0 ~ ~ ~ 0 0 0 0 0 normal
